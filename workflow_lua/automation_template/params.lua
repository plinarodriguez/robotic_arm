...
local Par = {
    ...
    bottle_params{
        ...
        blendR = -1.0, -- I had 0 before but this might be safer: -1 = for no blending
        search = 0,
        offset = 0,
    ...
    -- z position values since they will have the same x & y 
    ...
    -- Joint seed is the inverse kinematic function requirement
    bottle_params = -1,
}
return Par
...
Lin(single_bottle2_approach,75,-1,0,0)
Lin(single_bottle2_grab,50,-1,0,0)
MoveGripper(1,0,75,17,5000,0,0,0,0,0)
Lin(single_bottle2_approach,50,-1,0,0)
Lin(filler_under_approach,75,-1,0,0)
Lin(filler_edge,50,-1,0,0)
Lin(filler_insert,25,-1,0,0)
WaitMs(3000)
...
Lin(single_bottle3_approach,75,-1,0,0)
Lin(single_bottle3_grab,50,-1,0,0)
MoveGripper(1,0,75,17,5000,0,0,0,0,0)
Lin(single_bottle3_approach,50,-1,0,0)
Lin(filler_under_approach,75,-1,0,0)
Lin(filler_edge,50,-1,0,0)
Lin(filler_insert,25,-1,0,0)
WaitMs(3000)

...
local Z_positions = {approach = 160.0, btw = 155, grab = 119} --might change the btw to 145 to be closer to the neck of the bottle

-- ########## Double check that these points are all correct!!!!!!###########################
-- Row definitions from your data_points.txt
local ROWS = {
  [1]  = {start_x = 195.0 , start_y = -316.5, dx_steps = {57.0, 57.0, 57.5, 57.0, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [2]  = {start_x = -63.0 , start_y = -325.0, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [3]  = {start_x = 195.0 , start_y = -349.0, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [4]  = {start_x = -63.0 , start_y = -357.5, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [5]  = {start_x = 194.0 , start_y = -381.5, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },  
  [6]  = {start_x = -64.0 , start_y = -390.0, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [7]  = {start_x = 193.0 , start_y = -414.0, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [8]  = {start_x = -64.5 , start_y = -423.0, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [9]  = {start_x = 192.0 , start_y = -448.0, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [10] = {start_x = -65.5 , start_y = -456.0, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [11] = {start_x = 191.0 , start_y = -480.0, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [12] = {start_x = -66.5 , start_y = -488.5, dx_steps = {57.5, 57.0, 57.5, 57.0},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [13] = {start_x = 189.5 , start_y = -513.0, dx_steps = {57.0, 57.0, 57.5, 56.5, 57.5}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [14] = {start_x = -67.0 , start_y = -521.0, dx_steps = {57.5, 57.0, 57.0, 56.5},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
  [15] = {start_x = 188.5 , start_y = -545.0, dx_steps = {57.0, 57.0, 57.5, 57.5, 57.0}, dy_steps = {1.0, 2.0, 2.0, 2.0, 2.0}, bottles = 6 },
  [16] = {start_x = -68.0 , start_y = -554.0, dx_steps = {56.5, 57.0, 57.0, 56.5},       dy_steps = {1.0, 2.0, 2.0, 2.0},      bottles = 5 },
}
